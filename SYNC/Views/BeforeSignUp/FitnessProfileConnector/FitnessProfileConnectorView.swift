                    ...
                    SyncBackButton {
                        ...
                        Task {
                            if let uid = signUpModel.uid {
                                await signUpModel.saveOnboardingStep(uid: uid, onboardingStep: .images)
...
//                    }
                    OnBoardingButton(text: "Next") {
                        ...
                        Task {
                            await signUpModel.saveProgress(uid: signUpModel.uid ?? "", key: nil, value: nil, onboardingStep: .fitnessLevel)
                        }
                    }
                }
            }
