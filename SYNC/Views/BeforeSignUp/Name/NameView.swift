                    ...
                    SyncBackButton {
                        ...
                        Task {
                            if let uid = signUpModel.uid {
                                await signUpModel.saveOnboardingStep(uid: uid, onboardingStep: .welcomeConnector)
                            }
                        }
                    }
                    Spacer()
...
//                    }
                    OnBoardingButton(text: "Next") {
                        ...
                        Task {
                            await signUpModel.saveProgress(uid: signUpModel.uid ?? "", key: "name", value: signUpModel.firstName + " " + signUpModel.lastName, onboardingStep: .age)
                        }
                    }
                    .disabled(
